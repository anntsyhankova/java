...
public class Main extends JFrame {
    ...
    public Main(Double[] coefficients) {
        ...
        Action helpAboutAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
                Box info = Box.createVerticalBox();
                JLabel author = new JLabel("Author: Ann Tsyhankova");
                JLabel group = new JLabel("Group: 7");
                ...
                JOptionPane.showMessageDialog(Main.this, info, "" + "О программе", JOptionPane.INFORMATION_MESSAGE);
            }
        };
        helpAboutMenuItem = helpMenu.add(helpAboutAction);
